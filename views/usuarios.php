                                ...
                                foreach($usuar as $usuario):?>
                                    <tr>
                                        ...
                                        <td class="opcionesTabla">
                                            <a href="actualizarUsuario.php?codigoUsuario=<?php echo $usuario->PK_CODIGO_USUARIO?>& nombreUsuario=<?php echo $usuario->NOMBRE_USUARIO?>& rolUsuario=<?php echo $usuario->rol_usuario?>& departamento=<?php echo $usuario->FK_ID_DEPARTAMENTO?>& sucursal=<?php echo $usuario->SUCURSAL?>& tipoUsuario=<?php echo $usuario->FK_TIPO_USUARIO?>"><input class="btn_update" type="button" value="update"></a>
