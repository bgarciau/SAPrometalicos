    ...
    foreach ($user as $userr): ?>
        ...
        <div class="contenedor">
            <div id="div_agregar_usuario">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">     <!-- formulario para agregar usuario -->
                    ...
                    <input class="inputUsuarios" type="text" name="nombreUsuario" value="<?php echo $userr->nom_usr ?>"><br> <!-- Se llama el codigo del usuario -->
                    ...
                    <br>
                    <a><input class="btn_cambiar_contraseña" type="submit" name="btn_actualizar" value="ACTUALIZAR"></a><br>
                </form>
                <button class="btn_cambiar_contraseña" type="button" id="btn_abrir_modal">Cambiar contraseña</button><br> <!-- Este boton abre el dialog que es un cuadro emergente, este se usa para cambiar la contraseña -->
                <dialog id="modal"> <!-- Este dialog es el recuadro emergente, y solo se ve cuando se le da al boton este contenido -->
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="f1"> <!-- Este formulario se usa para el cambio de contraseña -->
                        ...
                        <input class="inputUsuarios" type="hidden" name="codigoUsuario" value="<?php echo $cod_usr ?>"><br>
        ...
        function comprobarClave() { //funcion que comparar ambas claves y verificar que sean iguales
            ...
            if (clave1 == clave2) { //si las claves son iguales envia el formulario
                ...
                <a href="usuarios.php"><input class="btn_volver" type="button" value="< VOLVER"></a> <!-- boton para volver -->
