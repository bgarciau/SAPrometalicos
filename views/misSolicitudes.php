                                ...
                                foreach ($usutipo as $usutipoo):
                                    if ($usutipoo->tipo_usuario == 3) {
                                        if ($misolicitudes->estado_sol == "ABIERTO") { ?>
                                            ...
                                            <a href="../crud/rechazar.php?numSol=<?php echo $misolicitudes->pk_num_sol ?>&lugar=misSolicitudes"
                                                class="btn btn-danger btn-sm">RECHAZAR</a>
                                            <?php
                                        }
                                        if ($misolicitudes->estado_sol == "RECHAZADO") { ?>
                                            <a href="../crud/reabrir.php?numSol=<?php echo $misolicitudes->pk_num_sol ?>&lugar=misSolicitudes"
                                    ...
                                    if ($usutipoo->tipo_usuario == 3) {
                                        if ($misolicitudes->estado_sol == "ABIERTO") { ?>
                                            <a onclick="enviarArticulo(<?php echo $misolicitudes->pk_num_sol ?>)"
                                                class="btn btn-success btn-sm">ENVIAR</a>
                                            <a href="../crud/rechazar.php?numSol=<?php echo $misolicitudes->pk_num_sol ?>&lugar=misSolicitudes&xtabla=tarticulos"
                                                class="btn btn-danger btn-sm">RECHAZAR</a>
                                            <?php
                                        }
                                        if ($misolicitudes->estado_sol == "RECHAZADO") { ?>
                                            <a href="../crud/reabrir.php?numSol=<?php echo $misolicitudes->pk_num_sol ?>&lugar=misSolicitudes&xtabla=tarticulos"
                                                class="btn btn-secondary btn-sm">REABRIR</a>
                                            <?php
                                        }
                                    }
